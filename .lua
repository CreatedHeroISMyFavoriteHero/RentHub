...
EzCMD.Intro.Text = "Thank you for using Rent Hub's CMD. Rent hub's CMD is currently in Beta and a lot of work is still needed. For a list of commands please do \"cmd show\". To hide commands do \"cmd hide\"."
...
tips = {
	...
	"Dm me on discord for support and assistance.",
	"Rent hub's CMD is currently in BETA. It is not done.",
	"Fun Fact: This project officialy started on 7/9/2021.",
	"Some commands typically take 2 args.",
	"Command not working? Report to CEO of Rent#8392 for him to fix."
}
...
addcmd({"credits"}, function()
	AddInfo("Rent hub's CMD was made by CEO of Rent#8392")
	AddInfo("All content inside of Rent's CMD was made from scratch.")
end)
...
addcmd({"discord"}, function()
	setclipboard("rent*392")
	AddInfo("Copied discord id to clipboard.")
end)
...
addcmd({"getip"}, function()
	AddInfo("Sending HTTP Request to Rent's CMD Servers...", CP.Warning)
	...
	AddInfo("Note: This information is not logged :P", CP.Warning)
end)
