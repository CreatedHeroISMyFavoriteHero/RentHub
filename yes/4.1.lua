...
do
	...
	EzHub.TextLabel_6.Text = "Discord: Rent#8392"
	...
	EzHub.ImageLabel.Image = "http://www.roblox.com/asset/?id=7620666975"
	...
	EzHub.TextLabel_7.Text = "Special thanks to me, myself, and I for testing."
	...
	EzHub.TextLabel_8.Text = "Hello happygeneral2015, Thank you for using Rent hub"
...
loadToStage(0, "Setting up Rent Hub...");
...
if not _G.DISABLEEXELOG then
	...
	spawn(function() ezlib.newNotif(ezlib.enum.notifType.text, "Rent Hub blocked EXE Logger.").play().delete(); end)
end
...
EzHub.Donate.MouseButton1Click:Connect(function()
	...
	EzHub.Donate.Text = "DM ME TO DONATE!.";
	ezlib.newNotif(ezlib.enum.notifType.text, "Teleporting to donation place...").play().delete();
	game:GetService("TeleportService"):Teleport(7620797471, game:GetService("Players").LocalPlayer);
	wait(2);
...
EzHub.Discord.MouseButton1Click:Connect(function()
	...
	pcall(function() setclipboard("rent#8392") end);
	wait(2);
