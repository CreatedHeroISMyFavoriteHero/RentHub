...
local LoadingEzHubGUI = CreateInstance('ScreenGui',{DisplayOrder=0,Enabled=true,ResetOnSpawn=true,Name='LoadingRentHubGUI', Parent=game.CoreGui})
...
local EzHub = CreateInstance('ScreenGui',{DisplayOrder=0,Enabled=true,ResetOnSpawn=true,Name='RentHub', Parent=game.CoreGui})
